...
NOTE: 您的系统可能没有集群间 LIF。您仅在节点对的一个节点上具有集群管理 LIF。集群管理 LIF 显示在 _Record node1 port information_ 的 link:record_node1_information.html#step1["第 1 步"] 示例输出中。
...
.下一步是什么？
记录节点 2 信息后，link:retire_node2.html["停用 node2"]。

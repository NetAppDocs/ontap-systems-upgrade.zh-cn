...
NOTE: 您也可以使用 USB 启动选项执行网络启动。请参见知识库文章 link:https://kb.netapp.com/Advice_and_Troubleshooting/Data_Storage_Software/ONTAP_OS/How_to_use_the_boot_recovery_LOADER_command_for_installing_ONTAP_for_initial_setup_of_a_system["如何使用boot_recovery loader命令安装ONTAP 以进行系统初始设置"^]。
...
+
对于node2、为 `partner-sysid` 必须是要升级到AFF A900或FAS9500的node1中的节点。

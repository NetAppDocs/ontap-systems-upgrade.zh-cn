...
如果您已收到完整的全新AFF A30、AFF A150 A50、AFF A900、AFF A90、AFF、AFF A70、AFF C30、AFF C60、AFF C80、FAS2820或FAS9500系统(包括新机箱)、请参阅link:other_references.html["参考资料"]链接到_use "system controller replace"命令升级运行ONTAP 9.8或更高版本的控制器硬件_内容。

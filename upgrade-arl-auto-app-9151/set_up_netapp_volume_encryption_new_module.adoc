...
summary: '如果需要、在升级运行ONTAP 9.151或更高版本的控制器时、使用命令为NVE或NAE配置新控制器模块 `system controller replace` 。' 
---
...
.下一步是什么？
在新控制器模块上设置 NetApp 卷或聚合加密后，link:decommission_old_system.html["停用旧系统"]。

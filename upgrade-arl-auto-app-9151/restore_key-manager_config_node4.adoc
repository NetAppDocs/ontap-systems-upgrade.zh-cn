...
.下一步是什么？
在 node4 上恢复 key-manager 配置后，link:move_non_root_aggr_and_nas_data_lifs_node2_from_node3_to_node4.html["将 node2 拥有的非 root 聚合和 NAS 数据 LIF 从 node3 移动到 node4"]。

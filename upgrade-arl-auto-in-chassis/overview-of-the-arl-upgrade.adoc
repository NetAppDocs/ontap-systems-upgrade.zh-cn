...
| link:verify-upgrade-hardware.html["第 1 阶段：准备升级"]  a| 
...
| link:relocate-non-root-aggr-and-nas-data-lifs-node1-node2.html["第2阶段：重新定位资源并停用node1"]  a| 
...
| link:relocate-non-root-aggr-nas-lifs-from-node2-to-node1.html["第4阶段：重新定位资源并停用node2"]  a| 
...
| link:install-aff-a30-a50-c30-c50-node2.html["阶段 5：安装 node2 替换系统模块"]  a| 
...
| link:cable-node2-for-shared-cluster-HA-storage.html["第6阶段：使用替代系统模块启动node2"]  a| 
...
|===
.下一步是什么？
了解 ARL 升级顺序后，link:verify-upgrade-hardware.html["验证升级硬件"]。

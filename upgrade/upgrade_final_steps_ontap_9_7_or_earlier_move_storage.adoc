...
这些步骤适用于运行 ONTAP 9.7 或更早版本的系统。如果您运行的是ONTAP 9.8或更高版本、则必须在中使用操作步骤 xref:upgrade-final-upgrade-steps-in-ontap-9-8.adoc[在ONTAP 9.8或更高版本中执行最终升级步骤]。

.步骤
. 如果系统运行的是ONTAP 9.8或更高版本、请使用*停止*。您必须在中使用操作步骤 xref:upgrade-final-upgrade-steps-in-ontap-9-8.adoc[在ONTAP 9.8或更高版本中执行最终升级步骤]。

...
.相关信息
* link:upgrade_aff_a250_to_aff_a400_ndu_upgrade_workflow.html["了解如何将 AFF A250 转换为驱动器架并将存储转移到 AFF A400"] （无中断过程）
* link:convert-to-drive-shelf.html["通过转换为驱动器架，从 AFF A150、AFF A220 或 FAS2820 升级"] （无中断过程）

...
| FAS2720 | 9.13.1 或更高版本 | FAS2820 | 9.13.1 或更高版本 


| FAS2760 | 9.11.1P7 或更早版本 | FAS2820 | 9.13.1 或更高版本 
...
.下一步是什么？
在决定是否使用此 ARL 程序之后，了解 link:required_tools_and_documentation.html["所需的工具和文档"]。

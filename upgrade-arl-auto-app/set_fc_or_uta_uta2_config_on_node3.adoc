...
| 是 V 系列系统或具有 FlexArray 虚拟化软件并连接到存储阵列  a| 
** 如果 node3 具有 UTA/UTA2 卡或 UTA/UTA2 板载端口，请转至部分 <<检查并配置 node3 上的 UTA/UTA2 端口>>。
** 如果 node3 没有 UTA/UTA2 卡或 UTA/UTA2 板载端口，请跳过部分 <<检查并配置 node3 上的 UTA/UTA2 端口>> 并返回到 _Install and boot node3_ 部分，然后在继续 link:install_boot_node3.html#step23["第 23 步"]。

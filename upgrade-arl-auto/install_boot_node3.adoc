...
summary: 在机架中安装 node3 ，将 node1 的连接传输到 node3 ，启动 node3 并安装 ONTAP 。 
---
= 安装并启动 node3
:hardbreaks:
:nofooter: 
...
. [auto9597_istall3_step29]] 对于 MetroCluster 配置， V 系列系统以及将 FlexArray 虚拟化软件连接到存储阵列的系统，请转至 link:set_fc_or_uta_uta2_config_on_node3.html#auto9597_check_node3_step15["检查并配置节点 3 上的 UTA/UTA2 端口，步骤 15"]。

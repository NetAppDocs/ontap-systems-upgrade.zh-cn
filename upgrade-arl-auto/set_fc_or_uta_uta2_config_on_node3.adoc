...
** 如果 node3 具有 UTA/UTA2 卡或 UTA/UTA2 板载端口，请转至部分 <<检查并配置 node3 上的 UTA/UTA2 端口>>。
** 如果 node3 没有 UTA/UTA2 卡或 UTA/UTA2 板载端口，请跳过部分 <<检查并配置 node3 上的 UTA/UTA2 端口>> 并返回到恢复时的 _Install and boot node3_ 部分 link:install_boot_node3.html#step23["第 23 步"]。

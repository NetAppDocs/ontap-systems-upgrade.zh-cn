...
| link:https://docs.netapp.com/us-en/ontap-systems-upgrade/upgrade-arl-auto-affa900/index.html["使用system controller Replace命令升级同一机箱中的控制器型号"^] | 介绍无中断升级保留旧系统机箱和磁盘的系统所需的聚合重新定位过程。 
